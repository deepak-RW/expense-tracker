...
function App() {
  ...
  const [transactionType, setTransactionType] = useState('expense'); // Only income/expense
  ...
  const fetchUserData = async (userId) => {
    ...
    if (profileData) {
      setInitialBudget(profileData.starting_balance);
    } else {
      await supabase.from('profiles').insert([{ id: userId, starting_balance: 0 }]);
    }
  };
            ...
            <div className="card add-card">
              ...
              <form onSubmit={addTransaction}>
                <div className="type-toggle">
                  <button 
                    type="button" 
                    className={transactionType === 'income' ? 'active inc' : ''} 
                  ...
                  <button 
                    type="button" 
                    className={transactionType === 'expense' ? 'active exp' : ''} 
